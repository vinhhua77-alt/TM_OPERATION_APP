        ...
        <div className="fade-in">
            ...
            {subView === 'menu' ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '10px' }}>
                    <button className="btn-login btn-outline" onClick={() => setSubView('staff')}>
                        👥 1. Quản lý nhân sự
                    </button>
                    <button className="btn-login btn-outline" onClick={() => alert("Tính năng đang phát triển")}>
                        🏪 2. Quản lý nhà hàng
                    </button>
                    <button className="btn-login btn-outline" onClick={() => alert("Tính năng đang phát triển")}>
                        ⚠️ 3. Quản lý sự cố
                    ...
                    <div className="grid-2 mt-10">
                        <button className="btn-login btn-outline" onClick={() => onNavigate('HOME')}>
                            QUAY LẠI TRANG CHỦ
                        </button>
                    </div>
                </div>
