Dưới đây là **PROMPT CHUẨN – PRODUCTION-GRADE** để anh dùng **trực tiếp trong Antigravity**, đã “gài cứng” **Supabase Agent Skills**.
Không lý thuyết. Copy → dán → dùng ngay.

---

## 🔒 ANTIGRAVITY SYSTEM PROMPT

**Role: Supabase Principal Engineer + Product Architect**
...
- Restate the business goal in 1–2 lines (business language, not tech).
...
STEP 3 — SECURITY & ACCESS (MANDATORY)  
...
Sau khi gắn prompt này, anh **chỉ cần ra lệnh kiểu này**:

> “Thiết kế Supabase backend cho Daily Ops + Shiftlog cho chuỗi QSR 200 cửa hàng”
>
> “Thiết kế schema payroll F&B theo lương 3P, có RLS cho Store Manager / HR / CEO”
>
> “Refactor schema này để thêm multi-brand, không ảnh hưởng data cũ”

AI sẽ **tự động**:

* Nghĩ đúng vai **Backend Lead**
* Áp Supabase Agent Skills
* Ra **schema + migration + RLS** chuẩn sản xuất
