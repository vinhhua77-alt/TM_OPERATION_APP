# TM OPERATION APP v3.0 – IMPLEMENTATION ROADMAP
...
### PHASE 0: THE OUTCOME ENGINE (Store Closing & Sales)
...
### PHASE 0.5: FEATURE FLAG & SYSTEM CONTROL
...
### PHASE 1: FOUNDATION (Workforce Time Engine)
...
### PHASE 2: BEHAVIOR CORE (Enhanced Shiftlog)
...
### PHASE 3: TRAINING HUB (Competency Matrix)
...
### PHASE 4: SCORING LAYER (Trust & Performance)
...
### PHASE 5: DECISION ENGINE (Career State Machine)
...
### PHASE 6: THE BRAIN (OPS Intelligence & Rules)
*Focus: Ra quyết định quản trị toàn diện.*
- **Tasks**: Build Rule Engine (60 Rules), Implement Anomaly Detection, `operational_metadata`.
- **Value**: CEO/Ops Director nhìn thấy nguyên nhân gốc rễ và hành động gợi ý.
- **PROMPT**: `Triển khai Rule Engine cho 60 Rules trong RULE_CATALOG_V3. Kết nối dữ liệu Shift -> Daily để tìm Root Cause.`
